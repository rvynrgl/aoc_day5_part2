fun main() {
    ...
    var seed:Long = 0
    val seedList = longArrayOf(2906961955,1600322402,2347782594,541904540,126821306,3411274151,919015581,654599767,3945616935,999146581)
    ...
    val testSeed = arrayOf(79,55)
    val testRange = arrayOf(14,13)
    var index = 0
    var x = 0
    var y = 0
    ...
    for(i in testSeed){
        index++
        x = i-1
        //println((i+testRange[index-1])-1)
        y = (i+testRange[index-1])-1
        while(x < y){
            x++
            println(x)
